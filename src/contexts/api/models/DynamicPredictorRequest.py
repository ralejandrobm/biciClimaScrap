...
class DynamicPredictorRequest(BaseModel):
    ...
    def validate_petal_length(cls, petal_length):
    ...
    def validate_petal_width(cls, petal_width):
    ...
    def validate_sepal_length(cls, sepal_length):
    ...
    def validate_sepal_width(cls, sepal_width):
